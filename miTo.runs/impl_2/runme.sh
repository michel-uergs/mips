...
HD_PWD='C:/Users/miche/OneDrive/Documentos/32-bitMips-master/miTo.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log miTo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miTo.tcl -notrace
